...
urlpatterns = [
    ...
    path("patients/sessions/<uuid:session_id>/ai-diagnosis/", AIDiagnosisView.as_view(), name="doctor-session-ai-diagnosis"),
    path("patients/sessions/<uuid:session_id>/notes/", DoctorNoteListCreateView.as_view(), name="doctor-session-notes"),
    path("patients/sessions/<uuid:session_id>/notes/draft/", DoctorNoteDraftView.as_view(), name="doctor-session-note-draft"),
    ...
    path("patients/sessions/<uuid:session_id>/prescriptions/check-interactions/", DrugInteractionCheckView.as_view(), name="doctor-drug-interaction-check"),
    ...
    path("patients/<uuid:patient_id>/summary/", PatientCrossSummaryView.as_view(), name="doctor-patient-cross-summary"),
